...
এই গাইডটি আপনার সার্ভারে সেভ করুন, প্রিন্ট করুন, বা টিমের সাথে শেয়ার করুন।  
কাস্টমাইজ করুন — আপনার ডোমেইন, ইউজার, স্ক্রিপ্ট যোগ করুন।

---

> ✍️ **প্রস্তুতকারক**: [আপনার নাম/টিম]  
> 📅 **শেষ আপডেট**: `$(date +%Y-%m-%d)`  
> 🌐 **সাপোর্টেড**: Zimbra 8.8.x, 9.x, 10.x (Open Source & Network Edition)

---

📁 **এই ফাইলটি `README.md` হিসেবে সেভ করুন** — আপনার `/opt/zimbra/docs/` বা `/root/zimbra-cheatsheet/` ফোল্ডারে।

---

💡 **PDF চান?** এই কন্টেন্টকে [Markdown to PDF](https://markdowntopdf.com) এ পেস্ট করুন → ডাউনলোড করুন।

---

✅ **আপনি এখন Zimbra CLI ম্যানেজমেন্টে পুরোপুরি প্রস্তুত — স্প্যাম থেকে শুরু করে ডেইলি অ্যাডমিনিস্ট্রেশন পর্যন্ত!**
